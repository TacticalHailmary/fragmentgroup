    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button1.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                startActivity(new Intent(Area2.this, Area1.class));
            }
        });

        button2.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                startActivity(new Intent(Area2.this,Area2.class));
            }
        });
        ...
        if(preferences.getInt("area", 4) == 2){
            ...
            hiding.setOnClickListener(new View.OnClickListener()
            {
                ...
                public void onClick(View v)
                {
                    ...
                    Toast.makeText(Area2.this, String.valueOf(score), Toast.LENGTH_SHORT).show();
